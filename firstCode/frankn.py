...
Score 4
   Does it run 1
   Names OK: 0.5
   Linted: 0.5 - nice attempt but the comments destract. The 'who am I' is good. The other stuff belongs in a README not here. The 'output' is just wrong: only on that laptop... shouldn't be here
   Language: 1
