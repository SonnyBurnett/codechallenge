'''
Score 7 and 1 bonus points
   Does it run 1
   Names OK: 1
   Linted: 1
   Language: 1. Great use of a generator. I would really like to see better use of list comprehensions
   Single Responsibility: 1 Some effort but still a lot going on
   DeepSource: 1  <--- Taco please check
   Tests: 1. Lovely tests!

Bonus point: 1
  API doc nicely done: 1 
'''
