...
Score 5.5
   Does it run 1
   Names OK: 1
   Linted:1. While normally comments are bad... Your's helped. I would prefer you put the comments into variable names/method names
   Language: 0.5 Used while with incremental value but also used for loops. List Comprehensions would be much better
