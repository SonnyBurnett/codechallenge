Score 4.5
   Does it run: 1
   Are the names ‘ok’ (subjective): 0.5 nbr_of_prime_factors isn't a normal method name.
   Does it look consistently linted: 1 point
   Use language libraries / list com: 0  - uses while true then exit
   Single Responsibility - 1 points - some attempt, although there are lots of responsibilities in most methods
   Deep source - 1 point
   Evaluate Tests:0
      
Bonus
   1 for nice description
