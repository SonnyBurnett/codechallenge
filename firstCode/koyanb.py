'''
Score 5.5
   Does it run 1. In practice I have no idea.... Taco help me... I am assuming 1
   Names OK: 1. The names were nice: you put a lot of effort into this and it shows. 
   Linted: 0.5  Nearly Lost half a mark because had lots of comments to explain things: normally I say if you use comments, rewrite, but actually the code was good enough without the comments. If you had put tests in place instead of comments that would be great
   Language: 0.5 Used while/break (bad) but also used for loops. List Comprehensions would be much better
   Single Responsibility: 1.5. Lot's of effort in this visible in the main code. You still have a lot of responsibilities in the your methods, but the decomposition you did is good
                                The gui code is all one big mess but that's OK it's not part of the evaluation. I hope you enjoyed making it! This sort of coding is fun
