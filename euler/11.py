...
for x in range(grid):
  for y in range(grid):
    ...
    if max_prd < ar_l_r[0]:
      max_prd = ar_l_r[0]
      max_info = [ar_l_r, 'Left-right', x, y]
    elif max_prd < ar_t_d[0]:
      max_prd = ar_t_d[0]
      max_info = [ar_t_d, 'Top-down', x, y]
    elif max_prd < ar_diag_l_r[0]:
      max_prd = ar_diag_l_r[0]
      max_info = [ar_diag_l_r, 'Diagonal Left Right', x, y]
    elif max_prd < ar_diag_r_l[0]:
      max_prd = ar_diag_r_l[0]
      max_info = [ar_diag_r_l, 'Diagonal Right Left', x, y]


print('Max product: {}, x:{}, y:{}, direction: {}, numbers: {}'.format(max_prd, max_info[2], max_info[3], max_info[1], max_info[0][1]))
